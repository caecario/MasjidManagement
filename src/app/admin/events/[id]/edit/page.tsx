...
import type { TemplateType, Event } from '@/lib/types'
    ...
    const fetchEvent = async () => {
      try {
        ...
        if (data) {
          ...
          setImageType(data.image_type || 'preset')
    ...
    <div>
      <div className="admin-topbar">
        <div className="flex items-center gap-md">
          ...
          <h1 className="admin-page-title">Edit Kajian / Event</h1>
        </div>
      </div>
        ...
        <div className="card">
          ...
          <div className="flex flex-col gap-md">
            ...
            <div className="form-group">
              ...
              <input className="form-input" value={speaker} onChange={(e) => setSpeaker(e.target.value)} />
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <div className="form-group">
                ...
                <input className="form-input" value={time} onChange={(e) => setTime(e.target.value)} />
              </div>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <div className="flex gap-md" style={{ marginTop: '0.5rem' }}>
                <label className="flex items-center gap-sm" style={{ cursor: 'pointer', fontSize: '0.875rem' }}>
                  ...
                  <span style={{ color: 'var(--green-700)', fontWeight: 600 }}>● Template Default</span>
                </label>
                <label className="flex items-center gap-sm" style={{ cursor: 'pointer', fontSize: '0.875rem' }}>
              ...
              <div>
                ...
                {imageUrl ? (
                  ...
                  <button
                    ...
                    disabled={uploading}
                    style={{ width: '100%', border: '2px dashed var(--gray-300)', borderRadius: 'var(--radius-md)', padding: '2rem', textAlign: 'center', color: 'var(--gray-500)', fontSize: '0.875rem', cursor: 'pointer', background: 'transparent' }}
                  >
            ...
            {imageType === 'custom' && imageUrl ? (
              <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.7) 0%, transparent 60%)', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '1.5rem' }}>
                  <h2 style={{ color: 'white', fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.5rem' }}>{title || 'Judul'}</h2>
              ...
              <div className={`template-slide template-${templateType.replace('_', '-')}`} style={{ position: 'relative' }}>
                ...
                <div className="template-content">
                  ...
                  <h2 className="template-title" style={{ fontSize: '1.5rem' }}>{title || 'Judul'}</h2>
                  <div className="template-meta">
                    <div className="template-meta-item" style={{ fontSize: '0.8125rem' }}><span>🎤</span><span>{speaker || 'Ustadz'}</span></div>
